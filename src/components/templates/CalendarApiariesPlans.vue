<template>
  <div class="subcontent">
    ...
    <div class="q-ma-sm q-gutter-sm row justify-center">
      ...
      <ButtonWrapper
        label="Day"
        :background="selectedView === 'day' ? '#d6d6d6' : '#F0F0F0F0'"
        flat
        click="click"
        color="#00000"
        @someAction="selectedView = 'day'"
        :class="[
          selectedView === 'day' && 'underlining-btn',
          'not-underlining-btn',
        ]"
      />
      <ButtonWrapper
        ...
        flat
        color="#00000"
        :background="selectedView === 'week' ? '#d6d6d6' : '#F0F0F0F0'"
        click="click"
        @someAction="selectedView = 'week'"
        :class="[
          selectedView === 'week' && 'underlining-btn',
          'not-underlining-btn',
        ]"
      />
      <ButtonWrapper
        label="Month"
        :background="selectedView === 'month' ? '#d6d6d6' : '#F0F0F0F0'"
        flat
        click="click"
        color="#00000"
        @someAction="selectedView = 'month'"
        :class="[
          selectedView === 'month' && 'underlining-btn',
          'not-underlining-btn',
        ]"
      />
    </div>
    ...
    <div class="row justify-center">
      <div
        style="display: flex; max-width: 800px; width: 100%; max-height: 400px"
      >
        <q-calendar
          ref="calendar"
          ...
          @click-time="
            (e) => {
              // const r = calendar.value.timeStartPos();
              console.log('wwwwwwwwwwwwww', e, d, s);
            }
          "
          @moved="
            (e) => {
              // const r = calendar.value.timeStartPos();
              console.log('wwwwwwwwwwwwwwwupdate', r);
            }
          "
          :drop-func="
            (e, d, s) => {
              // const r = calendar.value.timeStartPos();
              console.log('wwwwwwwwwwwwwwwdrag', e, d, s);
            }
          "
        >
